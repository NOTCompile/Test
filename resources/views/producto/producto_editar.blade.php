     ...
     <form action="{{ route('producto.producto_actualizar', $producto_editar->id) }}" method="POST" enctype="multipart/form-data" id="upload">
          ...
          <div class="form-row">
               <div class="form-group col-md-2">
                    ...
                    <input type="text" name="codigo_producto" class="form-control" value="{{ $producto_editar->codigo_producto }}">
               </div>
               
               <div class="form-group col-md-6">
                    <label for="">Nombre: </label>
                    <input type="text" name="nombre_producto" class="form-control" value="{{ $producto_editar->nombre_producto }}">
               </div>
               <div class="form-group col-md-4">
                    <label for="">Empresa: </label>
                    <input type="text" name="empresa_producto" class="form-control" value="{{ $producto_editar->empresa_producto }}" text="hola">
               </div>
          </div>

          <div class="form-group">
               <label for="">Ubicacion: </label>
               <input type="text" name="ubicacion_producto" class="form-control" value="{{ $producto_editar->ubicacion_producto }}">
          </div>
          ...
          <div class="form-row">
               ...
               <div class="form-group col-md-2">
                    ...
                    <input type="text" name="celular_producto" class="form-control" value="{{ $producto_editar->celular_producto }}">
               </div>
               <div class="form-group col-md-2">
                    <label for="">Hora de Inicio</label>
                    <input type="text" name="hora_inicio_producto" class="form-control" value="{{ $producto_editar->hora_inicio_producto }}">
               </div>
               <div class="form-group col-md-3">
                    <label for="">Hora de la Finalizacion</label>
                    <input type="text" name="hora_fin_producto" class="form-control" value="{{ $producto_editar->hora_fin_producto }}">
               </div>
          </div>
          ...
          <div class="form-row">
               <div class="form-group">
                    ...
                    <button class="btn btn-outline-success" type="submit"><i class="fa fa-floppy-o"></i>&nbsp;Actualizar</button>
               </div>
          </div>
